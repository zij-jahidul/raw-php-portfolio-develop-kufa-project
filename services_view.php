  ...
  <div class="col-md-4">
    ...
    <form method="post" action="service_post.php">
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="icon" name = "service_icon">
        <!-- <input type="hidden" name="id" value=""> -->
      </div>
      <div class="form-group">
        <label>Service Title</label>
        <input type="text" class="form-control" placeholder="title" name = "service_title">
      </div>
      <div class="form-group">
        <label>Service Describtion</label>
        <textarea name="service_describtion" rows="4" class = "form-control" placeholder="describtion"></textarea>
      </div>
      <div>
